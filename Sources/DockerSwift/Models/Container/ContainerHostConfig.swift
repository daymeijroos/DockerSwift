...
public struct ContainerHostConfig: Codable {
	...
	public init(
		...
		binds: [String]? = nil,
		blkioWeight: UInt16 = 0,
		blkioWeightDevice: [ContainerHostConfig.BlkioWeight]? = [],
		blkioDeviceReadBps: ContainerHostConfig.BlkioRateLimit? = nil,
		blkioDeviceWriteBps: ContainerHostConfig.BlkioRateLimit? = nil,
		blkioDeviceReadIOps: ContainerHostConfig.BlkioRateLimit? = nil,
		blkioDeviceWriteIOps: ContainerHostConfig.BlkioRateLimit? = nil,
		capabilityAdd: [String]? = nil,
		capabilityDrop: [String]? = nil,
		cgroup: String = "",
		cgroupNsMode: String = "",
		cgroupParent: String = "",
		...
		cpuPeriod: UInt64 = 0,
		cpuQuota: UInt64 = 0,
		cpuRealtimePeriod: UInt64 = 0,
		cpuRealtimeRuntime: UInt64 = 0,
		cpusetCpus: String = "",
		cpusetMems: String = "",
		cpuShares: UInt = 0,
		devices: [ContainerHostConfig.DeviceMapping]? = [],
		deviceCgroupRules: [String]? = nil,
		dns: [String]? = [],
		dnsOptions: [String]? = [],
		dnsSearch: [String]? = [],
		extraHosts: [String]? = [],
		...
		pidsLimit: UInt64? = 0,
		pidMode: String = "",
		portBindings: [ExposedPortSpec:[PortBinding]?]? = [:],
		...
		shmSize: UInt = 0,
		storageOpt: [String : String]? = nil,
		sysctls: [String : String]? = nil,
		tmpfs: [String : String]? = nil,
		ulimits: [ContainerHostConfig.Ulimit]? = nil,
		userNsMode: String = "",
		utsMode: String = "",
		volumeDriver: String = "",
